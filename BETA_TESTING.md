...
`capybara-lightpanda` is `0.3.0` — public beta. Real Rails suites are how we find the edges. This guide is the shortest path from "I'm curious" to "I have data and an opinion."
