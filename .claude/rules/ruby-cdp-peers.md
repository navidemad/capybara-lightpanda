...
**Last reviewed**: 2026-05-01 against Ferrum v0.17.2 (latest release 2026-03-24) and `main` HEAD `25367b52` (2026-04-22). No new commits on `main` since prior review (Ferrum quiet for 9 days). No gem-relevant changes — Outstanding adoption candidates and Diverged-on-purpose entries below stay valid.
...
**Last reviewed**: 2026-05-01 against Cuprite v0.17 (latest release 2025-05-11) and `main` HEAD `cc3a3da6` (2026-04-11). No new commits since prior review (Cuprite quiet for 20 days) — recent Cuprite features (rect, shadow_root, time inputs, focus-before-value, obscured?) are all already adopted.
