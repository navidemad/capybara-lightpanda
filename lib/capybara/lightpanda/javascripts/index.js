(function() {
  ...
  // --- Turbo Drive auto-disabler ---
  // Lightpanda cannot render Turbo Drive's fetch-then-replace-body pipeline.
  // Disabling Drive restores standard link navigation while keeping Turbo Frames
  // (lazy-loading, scoped navigation) fully functional.
  // Polls because Turbo loads as an ES module (async) — not available when this runs.
  (function() {
    var attempts = 0;
