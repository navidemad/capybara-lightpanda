  ...
  (function patchDispatch() {
    ...
    EventTarget.prototype.dispatchEvent = function (event) {
      try {
        ...
        try { Object.defineProperty(event, "target", { value: this, configurable: true }); } catch (_) {}
        var node = this.parentNode;
        while (node) {
          try { Object.defineProperty(event, "currentTarget", { value: node, configurable: true }); } catch (_) {}
          try { orig.call(node, event); } catch (_) {}
